...
#     && wget -q "https://pki.goog/repo/certs/gtsr4.pem" -O /usr/local/share/ca-certificates/gts-root-r4.crt \
...
# COPY --from=runtime-base /etc/ssl/certs/ /etc/ssl/certs/
# COPY --from=runtime-base /usr/share/ca-certificates/ /usr/share/ca-certificates/
